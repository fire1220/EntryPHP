...
*/
    ...
    //    'prefix' => '',//表前缀
        ...
        'WeixinUserAccredit'  =>    array(
            // 服务号
            'WeixinConf'  =>  array(
                'appid'  =>  '',//微信授权的AppId.位置:登录微信公众平台->开发->基本配置->公众号开发信息->开发者ID(AppID)
                'secret'  =>  '',//微信授权的秘钥secret.配置位置:登录微信公众平台->开发->基本配置->公众号开发信息->开发者密码(AppSecret)
        ...
        //         'Body' => '年会红包',//商品详情（商品名称）（这个信息会自动发给客户，可以在客户的交易记录里面看到）
        //         'Attach' => '年会红包',//附加备注，这个是备注的传值，异步回调可以接收到
        //         'Tag' => '年会',//标签
        //         'NotifyUrl' => '',//处理异步回调的文件,不支持参数,例如：http://common.hlj.sina.com.cn/yuanshenhongbao/index.php
        //     ),
